...
export default function StatCard({ icon, label, value, delta, accent = "#2095ae" }) {
  const isUp = typeof delta === "number" ? delta >= 0 : null;
  return (
    <div className="flex items-center gap-4 rounded-xl bg-white p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
      <div
