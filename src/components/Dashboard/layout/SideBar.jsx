...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-screen transition-all duration-300 overflow-y-scroll ${
        isOpen ? "w-64" : "w-20"
      } bg-white border-r`}
    >
      {/* Logo Section */}
      <Link href="/" className="flex items-center p-4">
        ...
        <h1
          className={`text-xl font-bold ml-2 ${isOpen ? "block" : "hidden"} transition-all duration-300`}
        >
          Go Ventures
        </h1>
      </Link>
